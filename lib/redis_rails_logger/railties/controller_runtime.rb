  ...
  module Railties
    module ControllerRuntime
      ...
      def process_action(action, *args)
        ...
        RedisRailsLogger::LogSubscriber.reset_runtime
        super
      end

      def cleanup_view_runtime
        redis_rt_before_render = RedisRailsLogger::LogSubscriber.reset_runtime
        runtime = super
        redis_rt_after_render = RedisRailsLogger::LogSubscriber.reset_runtime
      ...
      def append_info_to_payload(payload)
        super
        payload[:redis_runtime] = (redis_runtime || 0) + RedisRailsLogger::LogSubscriber.reset_runtime
      end
